...
export default class MathGrammar {
  ...
  constructor() {
    ...
    const rootExpr = [parenRule, expRule, expRuleRight, negRule, scalar];
    ...
    this.populateBinaryRules(rootExpr, asExpr, expRule, expRuleRight);
    parenRule.addChildren(1, ...asExpr);
    negRule.addChildren(1, ...asExpr);
    this.levels = [asExpr, mmdExpr, rootExpr];
  }
